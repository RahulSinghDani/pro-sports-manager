...
function AddNewStudent() {
  ...
  return (
    <div >
      <Button variant="contained" onClick={() => setOpen(true)}>+ Add New Student</Button>
      <Dialog open={open} onClose={() => setOpen(false)} className="add-student-dialog" style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
        <DialogActions style={{ }}>
          <p onClick={() => {setOpen(false); resetForm();}}
